...
fn main() {
    ...
    let green_box_medium = ShippingBox::new(Dimension::new(2.0, 6.0, 2.0), 60.0, Color::Green);
    let blue_box_heavy = ShippingBox::new(Dimension::new(2.0, 8.0, 2.0), 80.0, Color::Blue);
